...
function OrderSuccessContent() {
  ...
  const orderNumber = searchParams.get("orderNumber") || "#ZI-10025";

  return (
    <main style={{ padding: "64px 20px", background: "var(--cream)", minHeight: "70vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ maxWidth: 540, width: "100%", background: "var(--paper)", border: "1px solid var(--line)", borderRadius: 16, padding: "40px 32px", textAlign: "center", boxShadow: "0 10px 30px rgba(0,0,0,0.04)" }}>
        ...
        <div style={{ background: "var(--cream)", border: "1px solid var(--line)", borderRadius: 12, padding: 20, textAlign: "left", marginBottom: 28 }}>
          <div style={{ display: "flex", alignItems: "flex-start", gap: 14, marginBottom: 16 }}>
            ...
            <div>
              <strong style={{ display: "block", fontSize: 13, color: "var(--ink)", marginBottom: 2 }}>Payment & Invoice Generated</strong>
              <span style={{ fontSize: 12, color: "var(--muted)", lineHeight: 1.5, display: "block" }}>We have received your order details and created your official tax invoice.</span>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 14 }}>
            ...
            <div>
              ...
              <span style={{ fontSize: 12, color: "var(--muted)", lineHeight: 1.5, display: "block" }}>Your items are being carefully inspected, packed in eco-friendly linen bags, and dispatched.</span>
            </div>
          </div>
        </div>
